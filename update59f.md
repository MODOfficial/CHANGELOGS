...
* Zdun`s blade: Пассивная Time loop: При атаке есть шанс в 25% остановить время для врага на 1.5 секунды и заковать того в петлю времени - через 2 секунды после оглушения врага вернёт туда, где он был оглушен

* Almighty Mjolnir: Пассивная Lightning power: Вокруг героя появляются разряды молний, которые атакуют врагов каждые 2.5 секунды. При ударах по герою врага может ударить молния. При атаках по врагу может ударить молния. Все молнии перекидываются максимум на 4 юнитов.
